...
b1 = Book.create(title: "American Sniper", author: "Chris Kyle, Scott McEwen, Jim DeFelice", description: "A memoir about battlefield experiences in Iraq by the Navy SEALs sniper.", publisher: "Morrow/HarperCollins", weeks_on_list: 63, rank_this_week: 1, image: "https://images-na.ssl-images-amazon.com/images/S/pv-target-images/2322a5cd3be2e872be48aaebade50dd89bd7cacfba13a4e4314edfb099bf35a8._RI_V_TTW_.jpg")
...
b7 = Book.create(title: "The Power of Habit", author: "Charles Duhigg", description: "An examinatino of the science behind habits, how we form them and break them.", publisher: "Random House", weeks_on_list: 51, rank_this_week: 7, image: "https://images-na.ssl-images-amazon.com/images/I/819ZixpQzUL.jpg")
...
b11 = Book.create(title: "Метро 2033", author: "Дмитрий Глуховский", description: "Постапокалиптический роман Дмитрия Глуховского, описывающий жизнь людей в московском метро после ядерной войны на Земле.", publisher: "Эксмо", weeks_on_list: 89, rank_this_week: 11, image: "https://upload.wikimedia.org/wikipedia/ru/thumb/b/b1/Metro_2033_The_Last_Refuge_cover_xbox360.jpg/274px-Metro_2033_The_Last_Refuge_cover_xbox360.jpg")
...
Review.create(comment: "Тот, у кого хватит храбрости и терпения всю жизнь вглядываться во мрак, первым увидит в нем проблеск света.", author: "Хан", book_id: b11.id)
Review.create(comment: "Боже, какой прекрасный мир мы загубили…", author: "Михаил Порфирьевич", book_id: b11.id)
